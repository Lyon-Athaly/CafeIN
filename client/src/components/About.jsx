...
const sosmed = [
  ...
  { href: "https://Twitter.com/", label: "Twitter", logo: TwitterIcon },
];

const About = () => {
  return (
    <section className="relative flex gap-6 m-10 mt-32 mb-32">
      {/* About Photo */}
      <div className="max-w-200 max-h-150">
        <img src="/images/img-about.webp" className="rounded-3xl" />
      </div>

      {/* About Text */}
      <div className="flex flex-col justify-center gap-4">
        <h2 className="my-3 text-6xl font-extrabold">
